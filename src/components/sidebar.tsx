...
export default function Sidebar({
  ...
  return (
    <div className="hidden lg:flex min-w-[300px] bg-gray-100 dark:bg-neutral-900/80 border-r border-gray-300 dark:border-gray-800 flex-col gap-2 h-screen">
      ...
      <div className={`flex-1 overflow-y-auto mt-4 ${Styles.customScrollbar}`}>
